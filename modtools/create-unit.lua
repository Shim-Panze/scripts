...
Creates a unit.  Usage::
    ...
    -name entityRawName
        ...
        use the fort group entity in fortress mode only. If passed empty,
		will generate a "wild" name (random language, any words), i.e.
		the same type of name that animal people historical figures have.
        examples:
            MOUNTAIN
            EVIL
...
function nameUnit(unit, entityRawName)
  ...
  -- First name: preferred word converted to a string
